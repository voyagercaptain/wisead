...
function initgrid() {
    ...
    with(grid_sheet){
        ...
        var headers = [
                    {Text:"<s:message code='COMMON.HEADER.PROGRAM.XLS'/>", Align:"Center"}
                    /* No.|상태|삭제|요청구분|프로그램명|저장경로|프로그램한글명|URL|프로그램설명 */
                ];
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:100,  SaveName:"progrmFileNm",     Align:"Left", KeyField:1, Hidden:0}, 
                    {Type:"Text",   Width:100,  SaveName:"progrmStrePath",   Align:"Left", KeyField:1, Hidden:0},
                    {Type:"Text",   Width:100,  SaveName:"progrmKoreanNm",   Align:"Left" }, 
                    {Type:"Text",   Width:120,   SaveName:"url",   Align:"Left", KeyField:1, Hidden:0},
                    {Type:"Text",   Width:150,   SaveName:"progrmDc", Align:"Left"},
                ];
...
//     	ibsSaveJson = grid_sheet.GetSaveJson(1); //doAllSave와 동일한 대상을 가져옴...
        ...
        var url = "<c:url value="/commons/sys/program/regProgramlist.do"/>";
    	var param = "";
...
<div class="pop_tit" style="width:800px;">
    ...
    <div class="pop_tit_txt"><s:message code="EXCL.UPLOAD.-.PGM" /></div> <!-- 엑셀업로드-프로그램 -->
