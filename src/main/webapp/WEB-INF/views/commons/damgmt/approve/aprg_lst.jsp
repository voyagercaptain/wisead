...
<html>
<head>
<title><s:message code="APRL.GRP.MNG" /></title> <!-- 결재그룹 관리 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:40,  SaveName:"aprgId",    Align:"Left", Edit:0, Hidden:1},
                    ...
                    {Type:"Text",   Width:80,  SaveName:"aprgNm",    Align:"Left", Edit:1, Hidden:0, KeyField:1}, 
...
function doAction(sAction)
{
	...
	//      	grid_sheet.SetCellValue(nrow, "deptLvl"		, grid_sheet.GetRowLevel(nrow));
        ...
        case "Delete" :
        	...
        	var url = '<c:url value="/commons/sys/aprg/aprgDellist.do"/>';
        	var param = "";
        ...
        case "Save" :
        	...
        	var url = '<c:url value="/commons/sys/aprg/aprgReglist.do"/>';
...
<div class="menu_subject">
	<div class="tab">
	    <div class="menu_title"><s:message code="APRL.GRP.MNG" /></div> <!-- 결재그룹 관리 -->
	</div>
</div>
<!-- 메뉴 메인 제목 -->
...
<div id="search_div">
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='APRL.GRP.INQ' />"> <!-- 결재그룹 조회 -->
