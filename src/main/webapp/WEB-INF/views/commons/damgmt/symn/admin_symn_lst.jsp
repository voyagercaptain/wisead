...
// 	alert('window.load');
	...
	if(symnId != null && symnId != "" && symnId != "undefined") {
		grid_sheet.DoSearch("<c:url value="/meta/stnd/getSymnList.do" />", param);
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:40,  SaveName:"sbswdLnm",    Align:"Left", Edit:1, Hidden:0 ,KeyField:0}, 
                    {Type:"Text",   Width:40,  SaveName:"sbswdPnm",    Align:"Left", Edit:1, Hidden:0 ,KeyField:0},
...
function loadDetail(param) {
	$('div#detailInfo').load('<c:url value="/commons/damgmt/symn/ajaxgrid/admin_symn_dtl.do"/>', param, function(){
		//$('#tabs').show();
	});
}
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case 'SaveRow': //단건 저장
    		//saction (I-입력, U-수정)
    		var urls = '<c:url value="/meta/stnd/saveSymnRow.do"/>';
        ...
        case 'Save' : //엑셀 업로드용 저장
        	...
        	var url = '<c:url value="/meta/stnd/saveSymns.do"/>';
...
//         	setTreeCheckIBS(grid_sheet);
        	...
        	var url = '<c:url value="/meta/stnd/deleteSymnList.do"/>';
        	var param = "";
