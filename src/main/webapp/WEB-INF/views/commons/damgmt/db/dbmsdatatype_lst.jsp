...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headers = [
                    {Text:"<s:message code='COMMON.HEADER.DBMSDATATYPE.LST'/>", Align:"Center"}
                    /* No.|상태|선택|DBMS데이터타입ID|만료일시|시작일시|DBMS유형코드|데이터타입명|최대데이터길이|설명|버전|등록유형코드|작성일시|작성사용자ID */
                ];
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:40,  SaveName:"dbmsDataTypeId",    Align:"Center", Edit:0, Hidden:1},
                    ...
                    {Type:"Text",   Width:60,  SaveName:"dataTypeNm",    Align:"Left", Edit:1, Hidden:0, KeyField:1}, 
                    {Type:"Text",   Width:30,  SaveName:"maxDataLen",    Align:"Right", Edit:1, Hidden:0}, 
...
//         	setTreeCheckIBS(grid_sheet);
        	...
        	var url = '<c:url value="/commons/damgmt/db/datatypeDellist.do"/>';
        	var param = "";
        ...
        case "Save" :
        	...
        	var url = '<c:url value="/commons/damgmt/db/datatypeReglist.do"/>';
        ...
        case "Search":
        	...
        	//alert(param);
        	grid_sheet.DoSearch('<c:url value="/commons/damgmt/db/datatypeSelectlist.do" />', param);
...
<div class="menu_subject">
	<div class="tab">
	    <div class="menu_title"><s:message code="DB.MS.DATA.TY.MNG" /></div> <!-- DBMS 데이터타입 관리 -->
	</div>
</div>
<!-- 메뉴 메인 제목 -->
        ...
        <form id="frmSearch" name="frmSearch" method="post">
            ...
            <div class="tb_basic2">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='USER.INQ' />"> <!-- 사용자조회 -->
                   ...
                   <tbody>                          
                            <th scope="row"><label for="dataTypeNm"><s:message code="DATA.TY.NM" /></label></th> <!-- 데이터타입명 -->
                            <td><input type="text" name="dataTypeNm" id="dataTypeNm" /></td>  

	                            <th scope="row"><label for="dbmsTypCd"><s:message code="DB.MS.PTRN" /></label></th> <!-- DBMS유형 -->
                                <td><select id="dbmsTypCd" class="wd150" name="dbmsTypCd">
