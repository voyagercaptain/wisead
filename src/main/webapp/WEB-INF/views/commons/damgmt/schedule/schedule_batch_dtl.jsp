...
<!-- 	      </tr> -->
	      ...
	      <tr>
	        <th><s:message code="STRN.DD" /></th> <!-- 시작일 -->
	        <td>
...
<!-- 	        <td> -->
    ...
    <div id="divDtlBtn" style="text-align: center;">
			<button id="btnDtlSave" name="btnDtlSave" class="btnDtlSave"><s:message code="STRG" /></button> <!-- 저장 -->
			<button id="btnDtlReset" name="btnDtlReset" class="btnDtlReset"><s:message code="INON" /></button> <!-- 초기화 -->
		</div>
	</div>
</body>
