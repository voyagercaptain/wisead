...
//     	var cfg = {SearchMode:2,Page:100, DragMode:0};
        ...
        var headers = [
                    {Text:"<s:message code='COMMON.HEADER.CODEDTLMANAGE.LST.TEST'/>", Align:"Center"}];
        /* No.|상태|선택|구분코드|상세코드ID|상세코드|상세코드명|상세코드설명|버전|상위상세코드ID|출력순서 */
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:100,  SaveName:"commDtlCdId",   Align:"Left", Edit:0}, 
...
function grid_sub_OnDebugMsg(Msg) {
...
<!-- 	    <li id="tab-2"><a href="#tabs-2">상세코드리스트</a></li> -->
	  </ul>
	  <div id="tabs-1">
	<!-- 그리드 입력 입력 -->
	<div class="grid_01">
