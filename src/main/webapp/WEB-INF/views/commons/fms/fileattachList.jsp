...
<script type="text/javascript">
	...
	function fn_egov_deleteFile(atchFileId, fileSn) {
		...
		form.action = "<c:url value='/commons/fms/deleteFileInfs.do'/>";
		form.submit();
	}
		...
		<tr>
			...
			<c:choose>
				<c:when test="${updateFlag=='Y'}">
					<c:out value="${fileVO.orignlFileNm}"/>&nbsp;[<fmt:formatNumber value="${fileVO.fileMg/1024}" pattern="#,##0"/>&nbsp;KB]<%-- [<c:out value="${fileVO.fileMg/1024}"/>&nbsp;byte] --%>
					<img src="<c:url value='/img/commons/bu_icon_delete.gif' />" 
