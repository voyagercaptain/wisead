...
<dataset seriesName="${list.bizareaNm}"  showValues="1" >
	<set label="${list.bizareaNm}" value="${list.errRate}"/>
	<%-- <set label="${list.bizareaNm}" value="${list.errRate}" link="javascript:widgetsChartClick()"/> --%>
</dataset>
</c:forEach>
<styles>
	<definition>
