...
<c:forEach var="list" items="${list}">
	<set label="ÀüÃ¼" value="${list.cnt}"/>
</c:forEach>
</dataset>

<dataset seriesName="Ç¥ÁØ"  showValues="1" >
<c:forEach var="list" items="${list}">
	<set label="Ç¥ÁØ" value="${list.cntY}"/>
</c:forEach>
</dataset>

<dataset seriesName="ºñÇ¥ÁØ"  showValues="1" >
<c:forEach var="list" items="${list}">
	<set label="ºñÇ¥ÁØ" value="${list.cntN}"/>
</c:forEach>
</dataset>
