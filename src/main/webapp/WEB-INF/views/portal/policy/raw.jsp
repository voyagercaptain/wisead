...
<body>
<div class="right">
        	<div class="location"><img src='<c:url value="/img/location_home.gif"/>' alt="home"> &gt; 정책/지침 &gt; 법령/고시</div>
            <div class="stit">법령/고시</div>
...
<!--               <tr>
              ...
              <tr>
                ...
                <select name="">
                    ...
                    <option value="">법령</option>
                    <option value="">고시</option>
                </select>
                </td>
                <th>검색단어</th>
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="tb_bbslist" summary="">
              ...
              <tr>
                <td>198</td>
                <td>품질포탈</td>
                <td class="link_txt"><a href="#">법령고시지침법령고시지침법령고시지침법령고시지침법령고시지침</a></td>
                <td>2013.08.05</td>
              ...
              <tr>
                <td>198</td>
                <td>품질포탈</td>
                <td class="link_txt"><a href="#">법령고시지침</a></td>
                <td>2013.08.05</td>
				<td><img src='<c:url value="/img/icon_06.gif"/>' alt="첨부파일"></td>
                <td>홍길동</td>
                <td>1402</td>
