...
<body>
 <div class="right">
        	<div class="location"><img src='<c:url value="/img/location_home.gif"/>' alt="home"> &gt; 커뮤니티 &gt; 알림마당</div>
            <div class="stit">알림마당</div>
...
<!--               <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="tb_bbslist" summary="">
              ...
              <tr>
                <td>198</td>
                <td>품질포탈</td>
                <td class="link_txt"><a href="#">알림마당알림마당알림마당알림마당알림마당</a></td>
                <td>2013.08.05</td>
              ...
              <tr>
                <td>198</td>
                <td>품질포탈</td>
                <td class="link_txt"><a href="#">알림마당</a></td>
                <td>2013.08.05</td>
				<td><img src='<c:url value="/img/icon_06.gif"/>' alt="첨부파일"></td>
                <td>홍길동</td>
                <td>1402</td>
