...
<html>
<head>
<title><s:message code="PHYC.MDEL.TBL.EXCL.UPLOAD" /></title><!-- 물리모델테이블-엑셀업로드 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "<s:message code='META.HEADER.PDMTBL.XLS.1'/>";
        	headtext += "<s:message code='META.HEADER.PDMTBL.XLS.2'/>";
        	headtext += "<s:message code='META.HEADER.PDMTBL.XLS.3'/>";
        	headtext += "<s:message code='META.HEADER.PDMTBL.XLS.4'/>";

            //headtext  = "No.|상태|선택|요청구분|등록유형";
            //headtext += "|주제영역|테이블(물리명)|테이블(논리명)|이전테이블(물리명)";
            //headtext += "|표준적용여부|파티션테이블여부|DW대상테이블여부|보관주기|백업주기|삭제기준|삭제방법";
...
//                     {Type:"Text",   Width:150, SaveName:"pdmTblId",   	 Align:"Left",   Edit:0},
                    {Type:"Text",   Width:150,   SaveName:"fullPath",	 Align:"Left", 	 Edit:1, KeyField:1},
                    ...
                    {Type:"Text",   Width:100,  SaveName:"bfPdmTblPnm",   Align:"Left",   Edit:1},
                    
                    {Type:"Combo",  Width:80,  SaveName:"stdAplYn"	,    Align:"Left",   Edit:1},
                    {Type:"Combo",  Width:40,  SaveName:"partTblYn"	,    Align:"Left",   Edit:1},
                    {Type:"Combo",  Width:40,  SaveName:"dwTrgTblYn",    Align:"Left",   Edit:1},
                    {Type:"Text",   Width:60,  SaveName:"ctdFcy"	,    Align:"Left", Edit:1},
                    {Type:"Text",   Width:60,  SaveName:"bckFcy"	,    Align:"Left", Edit:1},
                    {Type:"Text",   Width:60,  SaveName:"delCri"	,    Align:"Left", Edit:1},
                    {Type:"Text",   Width:60,  SaveName:"delMtd"	,    Align:"Left", Edit:1},
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="PHYC.MDEL.TBL.EXCL.UPLOAD" /></div> <!-- 엑셀업로드-물리모델테이블 -->
