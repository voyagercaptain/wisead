...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var cols = [                        
                    ...
                    {Type:"Text",   Width:130,  SaveName:"dqiLnm",   	Align:"Left", Edit:0, TreeCol:1},
                    {Type:"Text",   Width:130,   SaveName:"uppDqiLnm", 	Align:"Left", Edit:0},
                    {Type:"Text",   Width:100,   SaveName:"dqiLvl", 	Align:"Center", Edit:0},
                    {Type:"Combo",  Width:80,   SaveName:"vrfcTyp", 	Align:"Center", Edit:0},
                    {Type:"Int",   Width:60,  SaveName:"bizruleCnt",  Align:"Right", Edit:0, DefaultValue:0},
...
function grid_sheet_OnSearchEnd(code, message, stCode, stMsg) {
	...
	for(i=0; i<grid_sheet.GetDataLastRow(); i++) {
		if(grid_sheet.GetCellValue(i, 'dqiLvl') == '1')
			grid_sheet.SetCellValue(i, 'bizruleCnt', '');
	}
}
