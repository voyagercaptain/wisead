...
<html>
<head>
<title><s:message code="IMCE.INFO.ITEM.INQ.EX.UP" /></title><!-- 중요정보항목 엑셀업로드 -->
...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headers = [
   					{Text:"<s:message code='DQ.HEADER.CTQ.XLS'/>", Align:"Center"}
   				];
        //No.|상태|선택|검토상태|검토내용|요청구분|등록유형|검증결과|중요정보항목명|레벨|상위중요정보항목명|설명|요청일시|요청자ID|요청자명|요청번호|요청일련번호
        ...
        var cols = [                        
					...
					{Type:"Text",   Width:130,  SaveName:"uppCtqLnm",   	Align:"Left", Edit:0, KeyField:0}, 
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="IMCE.INFO.ITEM.INQ.EX.UP2" /></div><!-- 엑셀업로드-중요정보항목 -->
