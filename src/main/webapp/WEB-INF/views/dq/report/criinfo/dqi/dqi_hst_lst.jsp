...
function inithstgrid() {
    ...
    with(grid_hst){
        ...
        var headers = [
                    {Text:"<s:message code='DQ.HEADER.DQI.HST.LST'/>", Align:"Center"}
                ];
                //No.|상태|선택|데이터품질지표ID|데이터품질지표명|상위데이터품질지표명|데이터품질지표레벨|데이터품질지표설명|버전|등록유형|시작일시|만료일시|최초요청일시|최초요청사용자ID|최초요청사용자명|요청일시|요청자ID|요청자명|승인일시|승인자ID|승인자명
