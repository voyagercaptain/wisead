...
<%-- 	  <input type="hidden" id="stwdId" name="stwdId" value="${result.stwdId}" > --%>
	...
	<div style="clear:both; height:10px;"><span></span></div>
		<div class="stit"><s:message code="DATA.QLTY.INFO.SPEC" /></div><!-- 데이터품질지표정보 -->
		<div style="clear:both; height:5px;"><span></span></div>
	<legend><s:message code="DATA.QLTY.INFO.SPEC" /></legend><!-- 데이터품질지표정보 -->
	<div class="tb_basic">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='DATA.QLTY.INDC'/>"><!--데이터품질지표-->
					<caption><s:message code="DATA.QLTY.INFO.SPEC.WRITE" /></caption><!-- 데이터품질지표 정보입력 -->
					<!-- 표에서 열의 그룹을 정의 -->
					<colgroup>
					<col style="width:30%;" />
					<col style="width:70%;" />
					...
					<tbody>
						...
						<tr>
							...
							<td>
        						...
        						<button class="btnSearchUppDqiPop" id="btnSearchUppDqiPop"><s:message code="INQ" /></button><!--검색-->
							</td>
						</tr>
						<tr>
