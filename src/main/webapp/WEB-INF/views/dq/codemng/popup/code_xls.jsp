    ...
    with(grid_pop){
        ...
        var headers = [
           ...
           var cols = [                        
                       ...
                       {Type:"Text",   	Width:100,  SaveName:"dbConnTrgId",    	Align:"Center", Edit:0, Hidden:0}, 
                       {Type:"Text",   	Width:100,  SaveName:"cdRuleNm",   	Align:"Left", Edit:0, Hidden:0},
                       {Type:"Text",   	Width:100,  SaveName:"cdSql",   	Align:"Left", Edit:0, Hidden:0, KeyField:1},
                       {Type:"Text",   	Width:100,  SaveName:"cdClsColNm",   	Align:"Left", Edit:0, Hidden:0},
                       {Type:"Text",   	Width:100,  SaveName:"cdClsNmColNm",   	Align:"Left", Edit:0, Hidden:0},
                       
                       {Type:"Text",   	Width:50,  SaveName:"cdIdColNm",   	Align:"Left", Edit:0, Hidden:0},
                       {Type:"Text",   	Width:100,  SaveName:"cdNmColNm",   	Align:"Center", Edit:0, Hidden:0, KeyField:1},
