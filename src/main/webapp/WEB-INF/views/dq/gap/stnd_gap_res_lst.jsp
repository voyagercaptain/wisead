...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        case "Search":	//요청서 재조회...
            ...
            url = "<c:url value="/dq/gap/getGapResultList.do" />"
...
//     	break;	
        ...
        case "Down2Excel":  //엑셀내려받기
            var fileName = "";
            if(bizDcd=="DBSDITM"){
            	fileName = 'DB표준용어 표준적용율 진단결과.xlsx';
            }else if(bizDcd=="DBDMN"){
            	fileName = 'DB표준도메인 표준적용율 진단결과.xlsx';
            }else if(bizDcd=="SDITM"){
            	fileName = '기관표준용어 표준적용율 진단결과.xlsx';
            }else if(bizDcd=="DMN"){
            	fileName = '기관표준도메인 표준적용율 진단결과.xlsx';
            }
...
<div id="tabs">
	  ...
	  <div id="tabs-DBSDITM">
			<div id="detailInfoDBSDITM"><%@include file="exl/res_dbstnditemgap_exl.jsp" %></div>
	  </div>
	  <div id="tabs-DBDMN">
			<div id="detailInfoDBDMN"><%@include file="exl/res_dbdmngap_exl.jsp" %></div>
	  </div>
	  <div id="tabs-SDITM">
			<div id="detailInfoSDITM"><%@include file="exl/res_stnditemgap_exl.jsp" %></div>
	  </div>
	   <div id="tabs-DMN">
			<div id="detailInfoDMN"><%@include file="exl/res_dmngap_exl.jsp" %></div>
	  </div>	 	  
</div>
