...
function initMtaColGapGrid()
{
    
    with(mtacolgap_sheet){
...
//         var headtext2 = "";
         ...
         headtext1 = "<s:message code='META.HEADER.STND.GAP.RESULT.LST1'/>";
...
//                     {Text:headtext2, Align:"Center"}
        ...
        var cols = [                        
            ...
            {Type:"Text",   Width:300,  SaveName:"colAplyCnt",           Align:"Left",    Edit:0}, 
            {Type:"Text",   Width:300,  SaveName:"colDupCnt",          Align:"Left",    Edit:0,Hidden:1}, 
            {Type:"Text",   Width:300,  SaveName:"colAplyRt",         Align:"Left",    Edit:0}, 
             {Type:"Text",   Width:300,  SaveName:"colErrCnt",         Align:"Left",    Edit:0, Hidden:1}, 
            {Type:"Text",   Width:300,  SaveName:"colErrRt",         Align:"Left",    Edit:0, Hidden:1}, 
        ];
...
/*
    ...
    y : y좌표
*/
function mtacolgap_sheet_OnDblClick(row, col, value, CellX, CellY, CellW, CellH) {
//     alert("tbl dbl click");
	if(row < 1) return;
}

function mtacolgap_sheet_OnClick(row, col, value, cellx, celly) {
...
function mtacolgap_sheet_OnSearchEnd(code, message) {
	if(code < 0) {
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="grid_01" class="grid_01">  
	     <script type="text/javascript">createIBSheet("mtacolgap_sheet", "100%", "650px");</script>     
