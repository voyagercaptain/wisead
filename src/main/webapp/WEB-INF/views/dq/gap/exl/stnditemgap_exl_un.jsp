...
function sditm_sheet_OnSearchEnd(code, message) {
	if(code < 0) {
		...
		$("#frmInputSditm #colErrCnt").val(sditm_sheet.GetEtcData("colErrCnt"));
		$("#frmInputSditm #colErrRt").val(sditm_sheet.GetEtcData("colErrRt"));
	}
...
<%-- 		        </colgroup> --%>
			      <tr>
			        <th>진단내용</th><!-- 업무규칙명 -->
			        <td>
			            <input type="hidden" id="anaCd" name="anaCd" value="07" readonly>
