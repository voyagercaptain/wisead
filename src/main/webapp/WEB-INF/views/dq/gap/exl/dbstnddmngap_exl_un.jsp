...
function dbdmn_sheet_OnSearchEnd(code, message) {
	if(code < 0) {
		...
		$("#frmInputDBDmn #colErrCnt").val(dbdmn_sheet.GetEtcData("colErrCnt"));
		$("#frmInputDBDmn #colErrRt").val(dbdmn_sheet.GetEtcData("colErrRt"));
	}
...
<%-- 		        </colgroup> --%>
			      <tr>
			        <th>진단내용</th><!-- 업무규칙명 -->
			        <td>
			            <input type="hidden" id="anaCd" name="anaCd" value="06" readonly>
