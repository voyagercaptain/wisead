...
// 		//진단결과 조회
		...
		$("#frmInputDBSditm #colAplyCnt").val(dbsditm_sheet.GetEtcData("colAplyCnt"));
		$("#frmInputDBSditm #colAplyRt").val(dbsditm_sheet.GetEtcData("colAplyRt"));
	}
}
...
<%-- 		        </colgroup> --%>
			      <tr>
			        <th>진단내용</th><!-- 업무규칙명 -->
			        <td>
			            <input type="hidden" id="anaCd" name="anaCd" value="01" readonly>
