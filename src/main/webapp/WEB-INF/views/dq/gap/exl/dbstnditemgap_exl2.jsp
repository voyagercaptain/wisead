...
function dbsditm_sheet_OnSearchEnd(code, message) {
	if(code < 0) {
		showMsgBox("ERR", "<s:message code="ERR.SEARCH" />");
		return;
	} else {
		
// 		for(var i = dbsditm_sheet.HeaderRows(); i <= dbsditm_sheet.RowCount() + dbsditm_sheet.HeaderRows() - 1; i++) {
			
// 			dbsditm_sheet.SetCellFontColor(i, "gapStatus", "#FF0000");
			
// 			var pdmColPnm = dbsditm_sheet.GetCellValue(i, "pdmColPnm"); 
			
// 			pdmColPnm = pdmColPnm.replace(/[0-9,_]+$/g, ''); //컬럼명끝 _ 숫자  제거
				
// 			if(pdmColPnm != dbsditm_sheet.GetCellValue(i, "sditmPnm")) { 			
// 				dbsditm_sheet.SetCellFontColor(i, "pdmColPnm", "#FF0000");
// 			} 	
			
// 			if(dbsditm_sheet.GetCellValue(i, "pdmDataType") != dbsditm_sheet.GetCellValue(i, "sditmDataType")) { 			
// 				dbsditm_sheet.SetCellFontColor(i, "pdmDataType", "#FF0000");
// 			} 	
...
// 			if(dbsditm_sheet.GetCellValue(i, "pdmDataLen") != dbsditm_sheet.GetCellValue(i, "sditmDataLen")) { 			
// 				dbsditm_sheet.SetCellFontColor(i, "pdmDataLen", "#FF0000");
// 			} 	
			
// 			if(dbsditm_sheet.GetCellValue(i, "pdmDataScal") != dbsditm_sheet.GetCellValue(i, "dbcDataScal")) { 			
// 				dbsditm_sheet.SetCellFontColor(i, "pdmDataScal", "#FF0000");
// 			} 	
// 		}
	}
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="grid_01" class="grid_01">  
	     <script type="text/javascript">createIBSheet("dbsditm_sheet", "100%", "650px");</script>     
