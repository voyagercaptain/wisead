...
// 		for(var i = sditm_sheet.HeaderRows(); i <= sditm_sheet.RowCount() + sditm_sheet.HeaderRows() - 1; i++) {
			
// 			sditm_sheet.SetCellFontColor(i, "gapStatus", "#FF0000");
			
// 			var pdmColPnm = sditm_sheet.GetCellValue(i, "pdmColPnm"); 
			
// 			pdmColPnm = pdmColPnm.replace(/[0-9,_]+$/g, ''); //컬럼명끝 _ 숫자  제거
				
// 			if(pdmColPnm != sditm_sheet.GetCellValue(i, "sditmPnm")) { 			
// 				sditm_sheet.SetCellFontColor(i, "pdmColPnm", "#FF0000");
// 			} 	
			
// 			if(sditm_sheet.GetCellValue(i, "pdmDataType") != sditm_sheet.GetCellValue(i, "sditmDataType")) { 			
// 				sditm_sheet.SetCellFontColor(i, "pdmDataType", "#FF0000");
// 			} 	
...
// 			if(sditm_sheet.GetCellValue(i, "pdmDataLen") != sditm_sheet.GetCellValue(i, "sditmDataLen")) { 			
// 				sditm_sheet.SetCellFontColor(i, "pdmDataLen", "#FF0000");
// 			} 	
			
// 			if(sditm_sheet.GetCellValue(i, "pdmDataScal") != sditm_sheet.GetCellValue(i, "dbcDataScal")) { 			
// 				sditm_sheet.SetCellFontColor(i, "pdmDataScal", "#FF0000");
// 			} 	
// 		}
	}
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="grid_01" class="grid_01">  
	     <script type="text/javascript">createIBSheet("sditm_sheet", "100%", "650px");</script>     
