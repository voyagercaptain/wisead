...
function dmn_sheet_OnSearchEnd(code, message) {
	if(code < 0) {
		...
		$("#frmInputDmn #colAplyCnt").val(dmn_sheet.GetEtcData("colAplyCnt"));
		$("#frmInputDmn #colAplyRt").val(dmn_sheet.GetEtcData("colAplyRt"));
	}
...
<%-- 		        </colgroup> --%>
			      <tr>
			        <th>진단내용</th><!-- 업무규칙명 -->
			        <td>
			            <input type="hidden" id="anaCd" name="anaCd" value="04" readonly>
