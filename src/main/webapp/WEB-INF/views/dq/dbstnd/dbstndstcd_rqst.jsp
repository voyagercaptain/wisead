...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
    	...
    	case "Save":  //검증
			...
			//grid상 중복데이터 검사 (기관명|DB명|코드명)
			/* var row  = grid_name.ColValueDup("orgNm|dbNm|commCdNm");
			var rows = grid_name.ColValueDupRows("orgNm|dbNm|commCdNm");
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="tabs">
	  ...
	  <div id="tabs-STCD">
			<div id="detailInfoDMN"><%@include file="exl/dbstndstcd_exl.jsp" %></div>
	  </div>
