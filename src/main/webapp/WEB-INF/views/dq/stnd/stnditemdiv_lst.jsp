...
$(document).ready(function() {
    ...
    // 엑셀업로 Event Bind
     ...
     setCodeSelect("dvRqstNo", "L", $("form[name=frmSearch] #dvRqstNo"));
...
function initGrid()
{
	...
	var cols = [						
				...
				{Type:"Text",     Width:200,  SaveName:"dvOrgDbNm",  Align:"Left", Edit:1, KeyField:0, Hidden:1},	
				...
				{Type:"Text",     Width:80,   SaveName:"infotpLnm", Align:"Left", Edit:0, Hidden:0},
				{Type:"Text",     Width:80,   SaveName:"dmnLnm", 	  Align:"Left", Edit:0, Hidden:1},
				{Type:"Text",   Width:100,  SaveName:"alwVal",      Align:"Left", Edit:0,  Hidden:0},
				{Type:"Text",   Width:100,  SaveName:"saveFrm", 	 	Align:"Left", Edit:0, Hidden:0, KeyField:0,  Hidden:0},
			    {Type:"Text",   Width:100,  SaveName:"exprsnFrm",	 	Align:"Left", Edit:0, Hidden:0,  Hidden:0},
			    {Type:"Text",   Width:100,  SaveName:"unit",    	 	Align:"Left", Edit:0, Hidden:0, Hidden:0},
				{Type:"Text",   Width:100,  SaveName:"admnStndCd", 	      Align:"Left", Edit:0, Hidden:0, ColMerge:0,  Hidden:0},  //행정표준코드명
				{Type:"Text",   Width:100,  SaveName:"ownrOrg",      Align:"Left", Edit:0, Hidden:0},  // 소관기관명
...
function doAction(sAction, param)
{
    ...
    {		    
        ...
        case "Search":
			...
			grid_sheet.DoSearch("<c:url value="/dq/stnd/getItemDvRqstList.do" />", param);
        	break;
...
// 				return;
// 			}
 	 	    var url = "<c:url value="/dq/stnd/regItemAutoDiv.do"/>";
 	 	...
 	 	case "Delete" : 
        	...
        	var url = '<c:url value="/dq/stnd/delItemAutoDiv.do"/>';
        	var param = "";
        ...
        case "RqstWrite":
        	...
        	var url = "<c:url value="/dq/stnd/regStndItemByDiv.do"/>";
        	var param = "";
            IBSpostJson2(url, SaveJson, param, ibscallback);
        	break;
        ...
        case "Down2Excel":  //엑셀내려받기
			grid_sheet.Down2Excel(    { HiddenColumn:1 , Merge:1, FileName:"단어분할(기관표준사전 기준).xlsx", Mode:2}    );
			break;
...
<!-- 							</td>		 -->
        ...
        <!-- 존재하지 않는 영문약어는 빨간색으로 표시됩니다. 데이터를 복사하시려면 복사할 컬럼을 선택하시고 -->
        <!-- 를 사용하시면 됩니다. -->
        </form>
