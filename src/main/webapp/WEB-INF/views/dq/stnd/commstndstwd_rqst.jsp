...
//     		}
		...
		case "Search":
			...
			if(bizDtlCd == "SDITM"){
				...
				url = '<c:url value="/dq/stnd/getStndCommWordlist.do"/>';
			}
...
// 				        grid_name.SetCellValue(rowsArr[i],"vrfRmk","중복데이터");
				...
				url = '<c:url value="/dq/stnd/regStndCommWordWamlist.do"/>';
			}
...
<%--                    <col style="width:35%;" /> --%>
                   ...
                   <tbody>      
                            <tr>
					         <th scope="row"><label for="orgNm">공통표준단어명</label></th> <!-- 사전유형 -->
                                <td >
                                <input type="text" id="stwdLnm" name="stwdLnm" class="wd98p" value="${stwdLnm}" />
								</td>
                                <th scope="row"><label for="objDescn">단어설명</label></th> <!-- 표준사전명 -->
...
<div style="clear:both; height:5px;"><span></span></div>
	...
	<div id="tabs">
	  ...
	  <div id="tabs-STWD">
			<div id="detailInfoSTWD"><%@include file="exl/commstndstwd_exl.jsp" %></div>
	  </div>	  
	 </div>
