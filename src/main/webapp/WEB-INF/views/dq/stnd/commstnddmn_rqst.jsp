...
<%--                    <col style="width:35%;" /> --%>
                   ...
                   <tbody>      
                            <tr>
					         <th scope="row"><label for="sditmLnm">공통표준도메인명</label></th> <!-- 사전유형 -->
                                <td >
                                <input type="text" id="dmnLnm" name="dmnLnm" class="wd98p" value="${dmnLnm}" />
								</td>
                                <th scope="row"><label for="objDescn">도메인설명</label></th> <!-- 표준사전명 -->
