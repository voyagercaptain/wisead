...
function grid_DMN_init() {
    ...
    with(grid_DMN){
		...
		*/
		var headtext  = "No.|상태|제정차수|선택|검토상태|검토내용|요청구분|등록유형|검증결과";
		headtext += "|도메인ID|공통표준도메인그룹명|공통표준도메인분류명|공통표준도메인명|공통표준도메인설명|데이터타입|데이터길이|소수점길이|저장형식|표현형식|단위|허용값|관리부서명|행정표준코드명";
