...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        // 엑셀내리기 Event Bind
        $("#btnExcelDown3").click( function(){ doAction("Down2Excel"); } );
	...
	function doAction(sAction)
	{
	    ...
	    switch(sAction)
	    {
	        case "Search":
				...
				grid_sheet.DoSearch("<c:url value="/dq/stnd/getcodegaplist.do" />", param);
			...
			grid_sheet.DoSearch("<c:url value="/dq/stnd/getcodeexistlist.do" />", param);
	        ...
	        case "Down2Excel":  //엑셀내려받기
	        	...
	        	if(flag == 1)
	           		grid_sheet.Down2Excel({HiddenColumn:1, Merge:1, FileName:"기관 코드정의서 진단결과.xlsx"});
	        	else
	        		grid_sheet.Down2Excel({HiddenColumn:1, Merge:1, FileName:"기관 코드정의서 일치목록 .xlsx"});
	            break;
...
<input id="tabNm" name="tabNm" type="hidden" value="SDITM"/>
	...
	<div class="bt02"><button class="btn_excel_down" id="btnExcelDown3" name="btnExcelDown3"><s:message code="EXCL.DOWNLOAD" /></button></div><!-- 엑셀 내리기 -->
	<div style="clear:both; height:5px;"><span></span></div>
 <div id="search_div3">
