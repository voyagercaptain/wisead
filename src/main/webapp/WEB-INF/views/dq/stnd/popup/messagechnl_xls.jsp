...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "No.|상태|선택|요청구분|등록유형";
        	headtext += "|오류코드|채널오류전문언어구분코드|오류유형코드|채널오류메세지내용|채널오류코드|오류코드사용여부|채널유형코드|채널세부코드|오류코드적용일자|조치코드";
        ...
        var cols = [                        
					...
					{Type:"Text",   Width:100,  SaveName:"errCd",  Align:"Left", Edit:0, KeyField:1},
					{Type:"Combo",  Width:100,  SaveName:"errTlgLanDscd",  Align:"Left", Edit:0, KeyField:1},
					{Type:"Combo",  Width:100,  SaveName:"errTpCd",  Align:"Left", Edit:0, KeyField:1}, 
					{Type:"Text",   Width:200,  SaveName:"chnlErrMsgCts",  Align:"Left", Edit:0, KeyField:1}, 
					{Type:"Text",   Width:100,  SaveName:"chnlErrCd",  Align:"Left", Edit:0, KeyField:1},
					{Type:"Combo",  Width:100,  SaveName:"errCdUsYn",  Align:"Left", Edit:0, KeyField:1}, 
					{Type:"Combo",  Width:100,  SaveName:"chnlTpCd",  Align:"Left", Edit:0, KeyField:1}, 
					{Type:"Combo",  Width:100,  SaveName:"chnlDtlsClcd",  Align:"Left", Edit:0, KeyField:1}, 
		...
		SetColProperty("errCdUsYn",	${codeMap.errCdUsYnibs});
		SetColProperty("chnlTpCd",	${codeMap.chnlTpCdibs});
		SetColProperty("chnlDtlsClcd",	${codeMap.chnlDtlsClcdibs});
...
//  	 	   	if(SaveJson.data.length == 0) return;
 	 	    ...
 	 	    var url = "<c:url value="/meta/stnd/regmsgchnlrqstlist.do"/>";
 	 		//iframe 형태의 팝업일 경우
        	var param = "";
        	if ("${search.popType}" == "I") {
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">엑셀업로드-채널오류메시지</div>
