...
function initGrid()
{
    ...
    with(grid_pop){
    	...
    	var headtext  = "No.|<s:message code='META.HEADER.MESSAGETSFWAM.POP.1'/>";
    	headtext += "|<s:message code='META.HEADER.MESSAGETSFWAM.POP.2'/>"
		headtext += "|<s:message code='META.HEADER.MESSAGETSFWAM.POP.3'/>";

		// headtext  = "No.|상태|선택";
    	//headtext += "|타겟DB_ID|타겟DB명|타겟스키마ID|타겟스키마명"
		//headtext += "|메시지ID|유형구분코드|업무구분코드|시스템구분코드|메시지코드|메시지내용|사용여부|객체설명|객체버전";
	     ...
	     var cols = [						
                    ...
                    {Type:"Int",   Width:30,  SaveName:"objVers",    Align:"Center", Edit:0, Hidden:1},
	 	    	];
...
function doAction(sAction)
{
    ...
    {		    
        ...
        case "Search":
        	...
        	grid_pop.DoSearch('<c:url value="/meta/stnd/getmessagetsfwam_pop.do" />', param);
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='MENU.INQ' />"> <!-- 메뉴조회 -->
                   ...
                   <tbody>
                   		<tr>                          
                            ...
                            <td>
                                <span class="input_file">
                                <select name="useYn" id="useYn" class="wd100">
                        ...
                        <tr>                          
                            ...
                            <td>
                               <select id="typDivCd" name="typDivCd" class="wd100">
							           <option value=""><s:message code="WHL" /></option> <!-- 전체 -->
                            ...
                            <td>
                               <select id="bizDivCd" name="bizDivCd" class="wd100">
							        <option value=""><s:message code="WHL" /></option> <!-- 전체 -->
