...
<html>
<head>
<title><s:message code="STRD.DMN.EXCEL.UPLOAD"/></title> <!-- 표준도메인엑셀업로드 -->
...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		var headtext  = "<s:message code='META.HEADER.STNDDMN.XLS.1'/>";
		headtext += "|<s:message code='META.HEADER.STNDDMN.XLS.2'/>";
		headtext += "|<s:message code='META.HEADER.STNDDMN.XLS.3'/>";
		headtext += "|<s:message code='META.HEADER.STNDDMN.XLS.4'/>";

		//headtext  = "No.|상태|삭제|요청구분|등록유형";
		//headtext += "|표준분류|도메인논리명|도메인물리명|논리명기준구분|물리명기준구분|도메인그룹|인포타입|데이터타입|길이|소수점|암호화여부";
		//headtext += "|용어자동생성여부|주제영역|코드값유형|코드값부여방식|데이터형식|대분류코드|목록엔티티논리명|목록엔티티물리명|목록어트리뷰트논리명|목록어트리뷰트물리명";
		//headtext += "|담당자ID|담당자명|설명";
	...
	var cols = [						
				...
				{Type:"Text",   Width:100,  SaveName:"dmnLnm",   	Align:"Left", Edit:1, KeyField:1},
				{Type:"Text",   Width:100,  SaveName:"dmnPnm",   	Align:"Left", Edit:1, KeyField:1}, 
				{Type:"Text",   Width:100,  SaveName:"lnmCriDs",   	Align:"Left", Edit:1, KeyField:1},
				{Type:"Text",   Width:100,  SaveName:"pnmCriDs",   	Align:"Left", Edit:1, KeyField:1},
// 				{Type:"Combo",   Width:60,   SaveName:"dmngId",	 	Align:"Left", Edit:0, Hidden:0},

				{Type:"Text",   Width:60,   SaveName:"dmngLnm",	 	Align:"Left", Edit:1, Hidden:0, KeyField:1},
// 				{Type:"Combo",   Width:60,   SaveName:"infotpId",	 	Align:"Left", Edit:0, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"infotpLnm",	 	Align:"Left", Edit:1, Hidden:0, KeyField:1},
				{Type:"Text",   Width:60,   SaveName:"dataType",	 	Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"dataLen",	 	Align:"Center", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"dataScal",	 	Align:"Center", Edit:1, Hidden:0},
				{Type:"Combo",   Width:60,   SaveName:"encYn",	 	Align:"Left", Edit:1, Hidden:0},				
				{Type:"Combo",   Width:60,   SaveName:"sditmAutoCrtYn",	 	Align:"Center", Edit:1, Hidden:0},
...
// 				{Type:"Text",   Width:60,   SaveName:"uppSubjLnm",	 	Align:"Left", Edit:0, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"fullPath",	 	Align:"Left", Edit:1, Hidden:0},
// 				{Type:"Text",   Width:60,   SaveName:"subjId",	 	Align:"Left", Edit:0, Hidden:0},
				{Type:"Combo",   Width:60,   SaveName:"cdValTypCd",	 	Align:"Center", Edit:1, Hidden:0},
				{Type:"Combo",   Width:60,   SaveName:"cdValIvwCd",	 	Align:"Center", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"dataFrm",	 	Align:"Left", Edit:0, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"dmnDscd",	 	Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"lstEntyLnm",	 	Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"lstEntyPnm",	 	Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"lstAttrLnm",	 	Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"lstAttrPnm",	 	Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"crgUserId",	 	Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"crgUserNm",	 	Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:120,  SaveName:"objDescn",	Align:"Left", 	 Edit:1, KeyField:1},
...
// 	 	   	ibsSaveJson = grid_sheet.GetSaveJson(1); //doAllSave와 동일한 대상을 가져옴...
        	...
        	if ("${search.popType}" == "I") {
 	 	    ...
 	 	    var url = "<c:url value="/dq/stnd/regdmnrqstlist.do"/>";
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="EXCEL.UPLOAD.STRD.DMN"/></div> <!-- 엑셀업로드-표준도메인 -->
