...
<html>
<head>
<title><s:message code="STRD.TERMS.EXCEL.UPLOAD"/></title> <!-- 표준용어-엑셀업로드 -->
...
//     		alert("저장할 대상이 없습니다...");
	...
	//항목 자동 분할 기능 추가....
	$("#btn_item_div").click(function(event){
		event.preventDefault();  //브라우저 기본 이벤트 제거...
		
		doAction("AutoDivision");
...
function initGrid()
{
    ...
    with(grid_sheet){
		...
		var headtext  = "<s:message code='META.HEADER.STNDITEM.XLS.1'/>";
		headtext += "<s:message code='META.HEADER.STNDITEM.XLS.2'/>";
		headtext += "<s:message code='META.HEADER.STNDITEM.XLS.3'/>";
	...
	var cols = [						
				...
				{Type:"Text",   Width:100,  SaveName:"lnmCriDs",  Align:"Left", Edit:1, KeyField:0}, 
				{Type:"Text",   Width:100,  SaveName:"pnmCriDs",  Align:"Left", Edit:1, KeyField:0}, 
				{Type:"Text",   Width:60,   SaveName:"dmnLnm", 	  Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"dmnPnm",   Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"dmngLnm",   Align:"Left", Edit:1, Hidden:0},
// 				{Type:"Combo",  Width:60,   SaveName:"infotpId",  Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"infotpLnm", Align:"Left", Edit:1, Hidden:0},
				{Type:"Text",   Width:60,   SaveName:"dataType",  Align:"Left", Edit:1, Hidden:0},
				{Type:"Int",    Width:60,   SaveName:"dataLen",	  Align:"Left", Edit:1, Hidden:0},
				{Type:"Int",    Width:60,   SaveName:"dataScal",  Align:"Left", Edit:1, Hidden:0},
				{Type:"Combo",  Width:130,  SaveName:"encYn",	  Align:"Center", Edit:1},	
				{Type:"Combo",  Width:130,  SaveName:"persInfoCnvYn",    Align:"Center", Edit:0, Hidden:1},
				{Type:"Combo",  Width:130,  SaveName:"persInfoYn",    Align:"Center", Edit:0},
...
//              break;
        ...
        case "AutoDivision":
        	...
        	grid_sheet.SetColProperty("sditmPnm", {KeyField:0});
...
//  	 	   	if(SaveJson.data.length == 0) return;
 	 	    ...
 	 	    var url = "<c:url value="/meta/stnd/regitemdivision.do"/>";
        	var param = "";
        	if ("${search.popType}" == "I") {
 	 	...
 	 	case 'Save' : //엑셀 일괄 저장
 	 		grid_sheet.SetColProperty("sditmPnm", {KeyField:1 });
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="EXCEL.UPLOAD.STRD.TERMS"/></div> <!-- 엑셀업로드-표준용어 -->
...
<!-- 		<button id="btn_item_div" name="btn_item_div">항목자동분할</button> -->
<!-- 	</div> -->
	<div class="divLstBtn" >	 
		<div class="bt03">
			...
			<button class="da_default_btn" id="btn_item_div" name="btn_item_div"><s:message code="ITEM.ATMD.DIV"/></button>
		</div> <!-- 항목자동분할 -->
		<div class="bt02">
