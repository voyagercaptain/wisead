...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headtext = "No.|상태|선택|대외기관매핑ID|오류코드|전산메세지오류원인내용|고객메세지오류원인내용|기관사용불가여부|대표오류코드여부|도메인명|도메인물리명|유효값(코드값)|유효값(코드값)명";			
        ...
        var cols = [                        
					...
					{Type:"Text",   Width:100,  SaveName:"msgMapId",  Align:"Left", Edit:0, Hidden:1},
					{Type:"Text",   Width:100,  SaveName:"errCd",  Align:"Left", Edit:0},
					{Type:"Text",   Width:200,  SaveName:"isdErrCasCts",  Align:"Left", Edit:0 }, 
					{Type:"Text",   Width:200,  SaveName:"osdErrCasCts",  Align:"Left", Edit:0 }, 
					{Type:"Combo",  Width:100,  SaveName:"isttUsImpoYn",  Align:"Left", Edit:0},
					{Type:"Combo",  Width:100,  SaveName:"rpstErcdYn",  Align:"Left", Edit:0}, 
					{Type:"Text",   Width:100,  SaveName:"dmnLnm",  Align:"Left", Edit:0},
					{Type:"Text",   Width:100,  SaveName:"dmnPnm",  Align:"Left", Edit:0},
					{Type:"Text",   Width:100,  SaveName:"cdVal",  Align:"Left", Edit:0},
					{Type:"Text",   Width:100,  SaveName:"cdValNm",  Align:"Left", Edit:0},
...
function doAction(sAction)
{
    ...
    {		    
        case "Search":
        	...
        	grid_pop.DoSearch('<c:url value="/meta/stnd/getMessageMapList.do" />', param);
...
// 			alert(saveJson.Code); 처리대상 행이 없는 경우 리턴한다.
        	...
        	param += "&rqstDcd=CU";
        	var url = "<c:url value="/meta/stnd/regWam2WaqMessageMap.do" />";
