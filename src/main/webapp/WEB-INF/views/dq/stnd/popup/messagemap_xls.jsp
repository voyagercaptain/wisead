...
function initGrid()
{
    ...
    with(grid_sheet){
        ...
        var headtext  = "No.|상태|선택|요청구분|등록유형";
        	headtext += "|오류코드|전산메세지오류원인내용|고객메세지오류원인내용|기관사용불가여부|대표오류코드여부|도메인명|도메인물리명|유효값(코드값)|유효값(코드값)명";
        ...
        var cols = [                        
					...
					{Type:"Text",   Width:200,  SaveName:"isdErrCasCts",  Align:"Left", Edit:0, KeyField:0}, 
					{Type:"Text",   Width:200,  SaveName:"osdErrCasCts",  Align:"Left", Edit:0, KeyField:0}, 
					{Type:"Combo",  Width:100,  SaveName:"isttUsImpoYn",  Align:"Left", Edit:0, KeyField:1},
					{Type:"Combo",  Width:100,  SaveName:"rpstErcdYn",  Align:"Left", Edit:0, KeyField:1}, 
					...
					{Type:"Text",   Width:100,  SaveName:"cdVal",  Align:"Left", Edit:0, KeyField:1},
		...
		SetColProperty("isttUsImpoYn", 	 {ComboCode:"N|Y", ComboText:"N|Y"});
		SetColProperty("rpstErcdYn", 	 {ComboCode:"N|Y", ComboText:"N|Y"});
...
//  	 	   	if(SaveJson.data.length == 0) return;
 	 	    ...
 	 	    var url = "<c:url value="/meta/stnd/regmsgmaprqstlist.do"/>";
 	 		//iframe 형태의 팝업일 경우
        	var param = "";
        	if ("${search.popType}" == "I") {
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt">엑셀업로드-대외기관오류코드매핑</div>
