...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headtext = "No.|<s:message code='META.HEADER.MESSAGE.POP'/>";
        //상태|선택|메시지ID|유형구분코드|업무구분코드|메시지코드|메시지내용|사용여부|객체설명|객체버전
...
//         	headtext += "|요청번호|요청일련번호|등록유형코드|최초요청일시|최초요청사용자ID|요청일시|요청사용자ID|승인일시|승인사용자ID";			
        ...
        var cols = [                        
                    ...
                    //{Type:"Text",   Width:30,  SaveName:"orgDs",    Align:"Left", Edit:0}, 
                    //{Type:"Combo",   Width:60,  SaveName:"wdDcd",    Align:"Center", Edit:0},
...
//              break;
        ...
        case "Search":
        	...
        	grid_pop.DoSearch('<c:url value="/meta/stnd/getMessageList.do" />', param);
...
// 			alert(saveJson.Code); 처리대상 행이 없는 경우 리턴한다.
        	...
        	param += "&rqstDcd=CU";
        	var url = "<c:url value="/meta/stnd/regWam2WaqMessage.do" />";
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="MESSAGE.INQ.1"/></div> <!-- 메시지 검색 -->
