...
//             headtext += "|<s:message code='META.HEADER.STNDDMN.POP.2'/>|데이터타입|길이|소수점";
...
//             headtext += "|<s:message code='META.HEADER.STNDDMN.POP.4'/>";
		...
		headtext += "|<s:message code='META.HEADER.STNDDMN.RQST.IFM.4'/>";
            //headtext = "No.|상태|선택";
            //headtext += "|도메인ID|표준분류|도메인논리명|도메인물리명|도메인그룹|인포타입|상위도메인ID|데이터타입|길이|소수점";
		...
		var headers = [
			...
			var cols = [
				...
				{Type:"Text",       Width:120,  SaveName:"dmnId",	 	    Align:"Left", Edit:1, Hidden:1, KeyField:0}, //도메인id
				{Type:"Text",       Width:120,  SaveName:"dmngLnm",	 	    Align:"Left", Edit:1, Hidden:0, KeyField:0}, //도메인그룹명
				{Type:"Text",       Width:180,  SaveName:"dmnLnm",   	    Align:"Left", Edit:1, KeyField:0}, //도메인분류명
// 				{Type:"Text",       Width:180,  SaveName:"dmnPnm",   	    Align:"Left", Edit:1, KeyField:0, Hidden:0}, 
				...
				{Type:"Text",       Width:100,  SaveName:"dataLen",	 	    Align:"Left", Edit:1, Hidden:0, KeyField:0},
				...
				{Type:"Text",       Width:60,   SaveName:"rqstUserNm",  Align:"Center", Edit:1}, 
				{Type:"Text",       Width:60,   SaveName:"rqstNo",      Align:"Center", Edit:1}, 
				{Type:"Int",        Width:60,   SaveName:"rqstSno",     Align:"Center", Edit:1}
					];
...
// 			alert(saveJson.Code); 처리대상 행이 없는 경우 리턴한다.
        	...
        	param += "&rqstDcd=CU";
        	var url = "<c:url value="/dq/stnd/regWam2WaqStndDmn.do" />";
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="<s:message code='STRD.TERMS.INQ' />"> <!-- 표준용어조회 -->
                   ...
                   <tbody>  
						...
						<th scope="row"><label for="dmnLnm"><s:message code="DMN.NM" /></label></th> <!-- 도메인명 -->
							...
							<td>
								<input type="text" id="dataType" class="wd100" name="dataType">
							</td>
							<th scope="row"><label for="objDescn"><s:message code="CONTENT.TXT" /></label></th> <!-- 설명 -->
							<td colspan=""><input type="text" class="wd200" id="objDescn" name="objDescn" /></td>
						</tr>
                   </tbody>
                 </table>   
            </div>
