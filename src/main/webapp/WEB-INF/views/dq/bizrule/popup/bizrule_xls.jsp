...
<html>
<head>
<title><s:message code="BZWR.RGR.EXCEL.UPLOAD"/></title><!--업무규칙 엑셀업로드-->
...
function initGrid()
{
    ...
    with(grid_pop){
        ...
        var headers = [
   					{Text:"<s:message code='DQ.HEADER.BIZRULE.XLS'/>", Align:"Center"}
   				];
/*         No.|상태|검토상태|검토내용|요청구분|등록유형|검증결과|업무영역ID|업무영역명|업무규칙ID|업무규칙명|업무규칙담당자ID|업무규칙담당자|"
    	+"진단대상ID|진단대상명|테이블명|컬럼명|품질지표ID|품질지표명|중요정보항목ID|중요정보항목명|사용여부|설명|"
    	+"건수SQL|분석SQL|검증대상명|검증테이블명|검증컬럼명|검증비교KEY컬럼|검증비교값컬럼|"
    	+"건수SQL(검증)|분석SQL(검증)
 */
        ...
        var cols = [                        
                    {Type:"Seq",    	Width:20,   SaveName:"ibsSeq",      Align:"Center", Edit:1, Hidden:0},
					...
					{Type:"Combo",  Width:80,  SaveName:"regTypCd",	Align:"Center", Edit:1, Hidden:1},						
					{Type:"Combo",  Width:120,  SaveName:"vrfCd",		Align:"Center", Edit:1, Hidden:1},	
                    {Type:"Text",   	Width:100,  SaveName:"bizAreaId",    	Align:"Center", Edit:1, Hidden:1}, 
                    {Type:"Text",   	Width:100,  SaveName:"bizAreaLnm",    	Align:"Center", Edit:1, Hidden:0, KeyField:1}, 
                    {Type:"Text",   	Width:100,  SaveName:"brId",   	Align:"Left", Edit:1, Hidden:1},
                    {Type:"Text",   	Width:100,  SaveName:"brNm",   	Align:"Left", Edit:1, Hidden:0, KeyField:1},
                    {Type:"Text",   	Width:100,  SaveName:"brCrgpUserId",   	Align:"Left", Edit:1, Hidden:1},
                    {Type:"Text",   	Width:100,  SaveName:"brCrgpUserNm",   	Align:"Left", Edit:1, Hidden:0},
                    {Type:"Text",   	Width:50,  SaveName:"dbConnTrgId",   	Align:"Left", Edit:1, Hidden:1},
                    {Type:"Text",   	Width:50,  SaveName:"dbConnTrgPnm",   	Align:"Center", Edit:1, Hidden:0, KeyField:1},
                    ...
                    {Type:"Text",   	Width:90,   SaveName:"dbcTblNm", 	Align:"Left", Edit:1, Hidden:0, KeyField:1},
                    {Type:"Text",   	Width:70,   SaveName:"dbcColNm", 	Align:"Left", Edit:1, Hidden:0, KeyField:1},
                    {Type:"Text",   	Width:70,   SaveName:"dqiId", 	Align:"Left", Edit:1, Hidden:1},
                    {Type:"Text",   	Width:70,   SaveName:"dqiLnm", 	Align:"Left", Edit:1, Hidden:0, KeyField:1},
                    {Type:"Text",   	Width:70,   SaveName:"ctqId", 	Align:"Left", Edit:1, Hidden:1},
                    {Type:"Text",   	Width:70,   SaveName:"ctqLnm", 	Align:"Left", Edit:1, Hidden:0},
                    {Type:"Text",   	Width:30,   SaveName:"useYn", 	Align:"Center", Edit:1, Hidden:1},
                    {Type:"Text",   	Width:30,   SaveName:"objDescn", 	Align:"Center", Edit:1, Hidden:1},
                    {Type:"Text",   	Width:50,   SaveName:"cntSql", 	Align:"Center", Edit:1, Hidden:0, KeyField:1},
                    {Type:"Text",   	Width:50,   SaveName:"anaSql", 	Align:"Center", Edit:1, Hidden:0, KeyField:1},
                    {Type:"Text",   	Width:50,   SaveName:"tgtDbConnTrgId", 	Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   	Width:50,   SaveName:"tgtDbcTblNm", 	Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   	Width:50,   SaveName:"tgtDbcColNm", 	Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   	Width:50,   SaveName:"tgtKeyDbcColNm", 	Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   	Width:50,   SaveName:"tgtKeyDbcColVal", 	Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   	Width:50,   SaveName:"tgtCntSql", 	Align:"Center", Edit:1, Hidden:0},
                    {Type:"Text",   	Width:50,   SaveName:"tgtAnaSql", 	Align:"Center", Edit:1, Hidden:0}
...
<div class="pop_tit" >
    ...
    <div class="pop_tit_txt"><s:message code="EXCEL.UPLOAD.BZWR.RGR"/></div><!--엑셀업로드-업무규칙-->
