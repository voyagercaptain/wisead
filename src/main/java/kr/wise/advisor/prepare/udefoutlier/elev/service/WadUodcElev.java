...
public class WadUodcElev extends WadUod {
	...
	private String otlColPnm;
	private String otlRt;
	...
	public String getOtlColPnm() {
		return otlColPnm;
	}
	public void setOtlColPnm(String otlColPnm) {
		this.otlColPnm = otlColPnm;
	}
	public String getOtlRt() {
		return otlRt;
	}
	public void setOtlRt(String otlRt) {
		this.otlRt = otlRt;
	}
