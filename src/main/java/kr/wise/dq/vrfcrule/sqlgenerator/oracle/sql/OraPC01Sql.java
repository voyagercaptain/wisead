...
public class OraPC01Sql {
	...
	public OraPC01Sql(Map<String, Object> sqlGenMap){
		...
		this.dbmsTypCd = prfMstrVO.getDbmsTypCd();
	...
	public String getNullCountSql() 
	{
		...
		strQuery.append("\n  WHERE 1 = 1 ");		
		if(dbmsTypCd.equals("ORA") || dbmsTypCd.equals("TIB")) {
			strQuery.append("\n    AND ( "+dbcColNm+" IS NULL OR "+dbcColNm+" = '' )  " );
			}else if(dbmsTypCd.equals("MRA") || dbmsTypCd.equals("MYS")) {
				strQuery.append("\n    AND  "+dbcColNm+" IS NULL AND "+dbcColNm+" = ''   " );
			}else if(dbmsTypCd.equals("POS")) {
				strQuery.append("\n    AND  "+dbcColNm+" IS NULL  " );
			}else if(dbmsTypCd.equals("CBR")) {
				strQuery.append("\n    AND  "+dbcColNm+" IS NULL AND "+dbcColNm+" = ''   " );
			}	
	...
	public String getSpaceCountSql() 
	{
		...
		if(dbmsTypCd.equals("POS")) {
			strQuery.append("\n  WHERE RTRIM(LTRIM("+dbcColNm+"::TEXT)) IS NULL ");
		}else {
	...
	public String getMinMaxLenSql() 
	{
		...
		strQuery.append("\n        ,MIN(LEN) AS MINLEN ");
		if(dbmsTypCd.equals("POS")) {
			strQuery.append("\n   FROM (SELECT LENGTH("+dbcColNm+"::TEXT) AS LEN ");
		}else {
	...
	{		
		...
		sb.append("\n                             FROM " + dbcTblNm + " BB                                                                               ");
		sb.append("\n                            WHERE " + dbcColNm + " IS NOT NULL                                                                   ");
		sb.append("\n                              AND LENGTH(TRIM(" + dbcColNm + ")) >= 2) AA                                                           ");
		sb.append("\n                          )            ELSE 'N'                                                                                  ");
		sb.append("\n             END AS DATE_YN                                                                                                      ");
		sb.append("\n   FROM WAT_DBC_COL COL                                                                                                              ");
	...
	{		
		...
		sb.append("\n              , COUNT(*) AS TOT_CNT                           ");
		sb.append("\n           FROM " + dbcTblNm + "                              ");
		sb.append("\n          WHERE ( " + dbcColNm + " IS NOT NULL OR "+dbcColNm+" != '') ");
		sb.append("\n          GROUP BY " + dbcColNm + "                           ");
		sb.append("\n        ) AA                                                     ");
