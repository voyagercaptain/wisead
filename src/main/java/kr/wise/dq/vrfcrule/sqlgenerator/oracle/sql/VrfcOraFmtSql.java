...
public class VrfcOraFmtSql {
	...
	public VrfcOraFmtSql(Map<String, Object> sqlGenMap){
		...
		//코드 SQL
		this.codeSql =   VrfcruleVO.getVrfcRule();
	...
	public String getErrorPatternSql() 
	{
		...
		strQuery.append("   SELECT M." + dbcColNm + " AS PATTERN       ");
