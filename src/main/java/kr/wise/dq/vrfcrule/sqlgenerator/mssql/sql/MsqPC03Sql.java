...
public class MsqPC03Sql {
	...
	public MsqPC03Sql(Map<String, Object> sqlGenMap){
	...
	public String getErrorCountDateValidCondSql_YYYYMMDDHH24MISS() {
		...
		.append("\n	      			                      THEN   ")
										...
										.append("\n	      		      THEN CASE WHEN (SUBSTRING(" + dbcColNm + ",1,4) % 4 ) = 0  ")
										.append("\n	      			            THEN CASE WHEN ( SUBSTRING(" + dbcColNm + ",1,4) % 400 ) = 0  ")
										.append("\n	      				                  THEN CASE WHEN SUBSTRING(" + dbcColNm + ",7,2) BETWEEN '01' AND '29'  ")
										.append("\n	      				                            THEN 1  ")
										.append("\n	      			     	                        ELSE 0  ")
										.append("\n	      			     	                    END ")
										.append("\n	      		                          ELSE CASE WHEN ( SUBSTRING(" + dbcColNm + ",1,4) % 100 ) = 0  ")
