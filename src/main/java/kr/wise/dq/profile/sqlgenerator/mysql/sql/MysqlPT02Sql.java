package kr.wise.dq.profile.sqlgenerator.mysql.sql;
...
public class MysqlPT02Sql {
	...
	public MysqlPT02Sql(Map<String, Object> sqlGenMap){
	...
	public String getErrorCountSql() 
	{
		...
		strQuery.append(" SELECT SUM(ERR_CNT) AS ERR_CNT ");
