...
public class ProgrmManageVO extends CommonVo{
	...
	public String toString() {
		...
		builder.append("ProgrmManageVO [progrmFileNm=").append(progrmFileNm)
				.append(", progrmStrePath=").append(progrmStrePath)
				.append(", progrmKoreanNm=").append(progrmKoreanNm)
				.append(", url=").append(url).append(", progrmDc=")
				.append(progrmDc).append("]");
