...
public class FileMngCtrl {
    ...
    public String selectFileInfs(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam("param_atchFileId") String atchFileId,  Map<String, Object> commandMap, ModelMap model) throws Exception {
//	String atchFileId = (String)commandMap.get("param_atchFileId");
    	
    log.debug("attachFileID[{}]", atchFileId);
	...
	return "/commons/fms/fileattachList";
    }
    ...
    public String selectFileInfsForUpdate(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam("param_atchFileId") String atchFileId, //Map<String, Object> commandMap,
	    //SessionVO sessionVO,
...
//	String atchFileId = (String)commandMap.get("param_atchFileId");
    ...
    public String deleteFileInf(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam("returnUrl") String returnUrl,
    		//@ModelAttribute("board") BoardVO vo,  //SessionVO sessionVO,
...
//	    return "redirect:" + returnUrl;
	...
	return "/commons/fms/imgFileList";
    }
}
