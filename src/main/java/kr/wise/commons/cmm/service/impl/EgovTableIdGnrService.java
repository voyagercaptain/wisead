...
public class EgovTableIdGnrService extends AbstractDataBlockIdGnrService {
     ...
     */
	private Object allocateIdBlock(final int blockSize, final boolean useBigDecimals) throws Exception {
        	...
        	return transactionTemplate.execute(new TransactionCallback<Object>() {
        		...
        		public Object doInTransaction(TransactionStatus status) {
        			...
        			try {
        				...
        				throw new WiseBizException("error.idgnr.select.idblock");
        			}
        	        ...
        	        try {
        	        	...
        	        	status.setRollbackOnly();
        	        	throw new WiseBizException("error.idgnr.update.idblockk");
        	        }
        		}
			});
     ...
     * @throws FdlException ID생성을 위한 블럭 할당이 불가능할때
     */
    public long allocateLongIdBlock(int blockSize) throws Exception {
