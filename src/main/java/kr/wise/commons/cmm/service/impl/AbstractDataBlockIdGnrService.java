 ...
 * </pre>
 */
public abstract class AbstractDataBlockIdGnrService extends
        AbstractDataIdGnrService implements InitializingBean {
    /**
    ...
    protected long getNextLongIdInner() throws Exception {
        ...
        if (id < 0) {
            ...
            throw new WiseBizException("error.idgnr.greater.maxid");
        }
        mAllocated++;
