 ...
 */
package kr.wise.commons.cmm.pagenation;
...
public class DefaultPaginationRenderer extends AbstractPaginationRenderer {
	...
	public DefaultPaginationRenderer() {
        ...
        previousPageLabel 	= "<a href=\"#\" class=\"paging_navi\" onclick=\"{0}({1}); return false;\">&lt; 이전페이지</a>";
        currentPageLabel 	= "<a href=\"#\" class=\"paging_select\" >{0}</a>";
        otherPageLabel 		= "<a href=\"#\" class=\"paging_num\" onclick=\"{0}({1}); return false;\">{2}</a>";
        nextPageLabel 		= "<a href=\"#\" class=\"paging_navi\" onclick=\"{0}({1}); return false;\">다음페이지 &gt;</a>";
