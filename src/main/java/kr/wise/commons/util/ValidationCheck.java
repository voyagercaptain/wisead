...
*/
     ...
     * @return
     */
    public static String checkSditmDate(Date data) {
        try {
            if (data == null) {
     ...
     * @return
     */
    public static String checkDmnDate(Date data) {
    	 try {
             if (data == null) {
     ...
     * @return
     */
    public static String checkWordDate(Date data) {
    	 try {
             if (data == null) {
     ...
     * @return
     */
    public static String checkCodedDate(Date data) {
    	 try {
             if (data == null) {
