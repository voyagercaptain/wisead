...
public class BoardMasterVO extends BoardMaster  implements Serializable {
	...
	public String toString() {
		...
		builder.append("BoardMasterVO [searchBgnDe=").append(searchBgnDe)
				.append(", searchCnd=").append(searchCnd)
				.append(", searchEndDe=").append(searchEndDe)
				.append(", searchWrd=").append(searchWrd).append(", sortOrdr=")
				.append(sortOrdr).append(", searchUseYn=").append(searchUseYn)
				.append(", pageIndex=").append(pageIndex).append(", pageUnit=")
				.append(pageUnit).append(", pageSize=").append(pageSize)
				.append(", firstIndex=").append(firstIndex)
				.append(", lastIndex=").append(lastIndex)
				.append(", recordCountPerPage=").append(recordCountPerPage)
				.append(", rowNo=").append(rowNo).append(", frstRegisterNm=")
				.append(frstRegisterNm).append(", bbsTyCodeNm=")
				.append(bbsTyCodeNm).append(", bbsAttrbCodeNm=")
				.append(bbsAttrbCodeNm).append(", tmplatNm=").append(tmplatNm)
				.append(", lastUpdusrNm=").append(lastUpdusrNm)
				.append(", authFlag=").append(authFlag)
				.append(", tmplatCours=").append(tmplatCours)
				.append(", useAt=").append(getUseAt()).append("]");
